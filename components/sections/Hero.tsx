      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="text-center">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-56 h-56 md:w-72 md:h-72 relative drop-shadow-[0_0_50px_rgba(201,162,39,0.4)]">
              <Image src="/logo-cicero.png" alt="Abogados del Ecuador" fill className="object-contain" priority />
            </div>
          </div>
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-10">
            Un espacio de encuentro entre personas que buscan asesoria legal y profesionales del derecho en Ecuador. Este
            directorio es solo informativo.
          </p>

          {/* Disclaimer */}
          <p className="text-sm text-gray-500 max-w-xl mx-auto mb-10">
            {"* El listado de profesionales no constituye recomendacion ni garantia de servicios. Cada abogado es responsable de su practica profesional."}
          </p>
