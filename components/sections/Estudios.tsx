...
const estudios = [
  {
    id: 1,
    nombre: "Perez Bustamante & Ponce",
    descripcion: "Firma lider en derecho corporativo, bancario y tributario. Reconocida internacionalmente por Chambers & Partners.",
    ...
    abogados: 45,
    especialidades: ["Economico", "Administrativo", "Penal"],
  ...
  },
  {
    ...
    descripcion: "Firma boutique especializada en derecho corporativo, energia y recursos naturales.",
    ubicacion: "Av. Republica del Salvador N34-107 y Suiza, Quito",
    telefono: "+593 2 381 0950",
    email: "info@corralrosales.com",
    web: "https://www.corralrosales.com",
    abogados: 25,
    especialidades: ["Economico", "Administrativo"],
  ...
  },
  {
    ...
    descripcion: "Firma lider en Guayaquil especializada en derecho corporativo, maritimo y energia.",
  ...
  },
  {
    id: 4,
    nombre: "ROBALINO",
    descripcion: "Firma especializada en derecho corporativo, M&A y resolucion de disputas.",
    ...
    abogados: 20,
    especialidades: ["Economico", "Penal"],
  ...
  },
  {
    ...
    ubicacion: "Av. Republica N16-114 y Av. Eloy Alfaro, Quito",
  ...
  },
  {
    ...
    abogados: 15,
    especialidades: ["Administrativo", "Economico"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-foreground mb-4">
            {"Estudios "}<span className="text-gradient">{"Juridicos"}</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            {"Listado de estudios juridicos en Ecuador. Informacion de contacto y areas de practica."}
          </p>
          <p className="text-sm text-gray-500 mt-4 max-w-xl mx-auto">
            {"* Este listado es informativo. La inclusion no implica recomendacion ni garantia de servicios."}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {estudios.map((estudio) => (
            <Card
              key={estudio.id}
              className="bg-[#1a1f2e] border-[#c9a227]/20 hover:border-[#c9a227]/40 transition-all duration-300 overflow-hidden group"
            >
              {/* Image */}
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-6 right-6">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#c9a227] to-[#8b7355] flex items-center justify-center text-[#0f1419] font-bold text-lg flex-shrink-0">
                      {estudio.logo}
                    </div>
                    <div>
                      <h3 className="text-foreground font-semibold text-lg">{estudio.nombre}</h3>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="flex gap-2">
                  <a href={`tel:${estudio.telefono.replace(/\s/g, "")}`} className="flex-1">
                    <Button variant="outline" size="sm" className="w-full border-[#c9a227]/50 text-[#c9a227] hover:bg-[#c9a227]/10">
